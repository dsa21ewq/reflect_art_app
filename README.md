...
```bash
cd /Users/oscar/Desktop/cup2/reflect_art_app
python3 -m venv .venv
...
- 新增上传图保持比例铺放，避免原图被强行拉伸
- 新增“目标镜面图自动铺满有效区域”，改善上传图未被充分利用的问题
- 新增越界区域高亮显示
- 新增纸面使用边框提示与纸面利用率指标
- 将界面重构为“主结果 / 输入与适配 / 诊断与热力图”三标签页
...
- 在第2问中加入“双图像同时有意义”的分层与频域复用实验
- 在第3问中加入“给定纸面图与镜面图的兼容性优化”模块
- 增加多视点鲁棒性与参数搜索模块
